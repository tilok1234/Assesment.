...
Shield entries likewise keep family and progression independent. `SHIELD_TIERS` currently exposes stable Tier 1 through Tier 4 ids, producing 33 meaningful off-hand states: none plus eight equipped shields at four tiers. Selecting no shield normalizes the tier to Tier 1, while old saved state and presets gain the backward-compatible Tier 1 default.
