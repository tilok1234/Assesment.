...
Weapon entries include a broad content category (`blade`, `blunt`, `polearm`, `ranged`, or `magic`) plus player-facing Tier 2, Tier 3, and Tier 4 names. The separate stable `WEAPON_TIERS` catalog keeps progression independent from weapon type, producing 61 meaningful equipment states: none plus 15 weapons at four tiers. The UI, randomizer, presets, and exports consume both catalogs generically.
