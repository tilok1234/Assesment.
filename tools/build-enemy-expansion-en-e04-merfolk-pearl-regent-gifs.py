...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e04-merfolk-pearl-regent"
...
raw_hash = build_gif(
    "raw",
    "en-e04-merfolk-pearl-regent-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e04-merfolk-pearl-regent-full-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Merfolk Pearl Regent full-suite GIFs.")
