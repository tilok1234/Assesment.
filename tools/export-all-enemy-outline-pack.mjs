...
const EXPECTED_FAMILY_COUNT = 67;
const EXPECTED_VARIANT_COUNT = 232;
...
function buildReadme({ source, generatedOn, pngCount }) {
  ...
  return [
    ...
    '',
    'Each folder contains `family-id/variant-id.png` paths for all 232 variants. The three treatments vary only the outline mode; Form shading remains enabled in all three.',
    '',
    '## Sheet contract',
    '',
