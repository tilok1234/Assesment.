...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e05-revenant"
...
raw_hash = build_gif(
    "raw",
    "en-e05-revenant-grave-oathkeeper-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e05-revenant-grave-oathkeeper-full-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled EN-E05 Revenant Grave Oathkeeper full-suite GIFs.")
