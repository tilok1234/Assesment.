...
check(EN_E06_IRONBOOT_TRAPPER_GATE.status === 'candidate' && EN_E06_IRONBOOT_TRAPPER_GATE.approvedOn === null && EN_E06_IRONBOOT_TRAPPER_GATE.publishedImplementation === null, 'candidate approval state drifted');
check(EN_E06_IRONBOOT_TRAPPER_GATE.approvalEvidence.includes('Pending designer review') && EN_E06_IRONBOOT_TRAPPER_GATE.approvalEvidence.includes('three exact PNG boards opened together in Aseprite'), 'pending approval evidence drifted');
...
check(EN_E06_IRONBOOT_TRAPPER_GATE.nextGate.includes('Stop for designer visual approval') && EN_E06_IRONBOOT_TRAPPER_GATE.nextGate.includes('Do not commit') && EN_E06_IRONBOOT_TRAPPER_GATE.nextGate.includes('begin Bloodcap Reaver'), 'candidate stop gate drifted');
