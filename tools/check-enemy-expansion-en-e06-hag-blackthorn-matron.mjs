...
check(ENEMY_EXPANSION_LEDGER.find(({ id }) => id === 'EN-E06')?.gate === 'dryad-spore-cantor-full-published-2026-08-09', 'ledger must preserve published Blackthorn Matron while identifying published Spore Cantor');
