...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e06-fairy"
...
raw_hash = build_gif(
    "raw",
    "en-e06-fairy-bramblewing-scout-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e06-fairy-bramblewing-scout-full-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled EN-E06 Fairy Bramblewing Scout full-suite GIFs.")
