...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e04-venom-motion-rajah-idle"
...
def build_gif(prefix: str, output_name: str) -> str:
    ...
    try:
        ...
        with Image.open(destination) as review:
            assert review.size == (640, 776), f"{output_name} must be 640x776"
...
raw_hash = build_gif(
    "raw",
    "en-e04-venom-motion-rajah-idle-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e04-venom-motion-rajah-idle-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact combined Venom-motion and Rajah-Idle GIFs.")
