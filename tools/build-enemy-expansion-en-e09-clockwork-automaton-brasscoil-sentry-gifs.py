...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e09-clockwork-automaton-brasscoil-sentry"
...
raw_hash = build_gif(
    "raw",
    "en-e09-clockwork-automaton-brasscoil-sentry-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e09-clockwork-automaton-brasscoil-sentry-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E09 Clockwork Automaton Brasscoil Sentry full-suite GIFs.")
