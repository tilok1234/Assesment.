...
check(EN_E06_SPRING_DANCER_GATE.status === 'candidate' && EN_E06_SPRING_DANCER_GATE.approvedOn === null && EN_E06_SPRING_DANCER_GATE.publishedImplementation === null, 'candidate preapproval state drifted');
check(EN_E06_SPRING_DANCER_GATE.approvalEvidence.includes('Pending explicit visual approval') && EN_E06_SPRING_DANCER_GATE.approvalEvidence.includes('three exact PNG review boards opened together in Aseprite'), 'pending approval evidence drifted');
...
check(EN_E06_SPRING_DANCER_GATE.nextGate.includes('exact frozen Spring Dancer candidate review') && EN_E06_SPRING_DANCER_GATE.nextGate.includes('Do not commit') && EN_E06_SPRING_DANCER_GATE.nextGate.includes('explicitly approves'), 'preapproval stop gate drifted');
