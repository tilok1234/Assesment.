...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e10-stag-mossrack-forager"
...
raw_hash = build_gif(
    "raw",
    "en-e10-stag-mossrack-forager-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e10-stag-mossrack-forager-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E10 Stag Mossrack Forager full-suite GIFs.")
