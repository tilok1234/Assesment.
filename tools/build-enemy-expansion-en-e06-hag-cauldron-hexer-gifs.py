...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e06-hag-cauldron-hexer"
...
raw_hash = build_gif("raw", "en-e06-hag-cauldron-hexer-full-suite-four-directions-labeled.gif")
assembled_hash = build_gif("complete-b-form", "en-e06-hag-cauldron-hexer-full-suite-four-directions-labeled-complete-b-form.gif")
print("Generated the two exact labeled EN-E06 Hag Cauldron Hexer full-suite GIFs.")
