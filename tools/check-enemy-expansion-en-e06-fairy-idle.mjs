...
check(ENEMY_EXPANSION_LEDGER.find((entry) => entry.id === 'EN-E06')?.gate === 'fairy-petalcrown-duelist-full-approved-2026-08-09', 'the expansion ledger must preserve the approved Idle baseline while identifying the approved Petalcrown Duelist gate');
