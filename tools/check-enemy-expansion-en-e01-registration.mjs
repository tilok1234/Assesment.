...
check(ledgerReport.counts.registeredFamilies === 35 && ledgerReport.counts.publicFamilies === 35, 'current ledger must report thirty-five registered approved families');
