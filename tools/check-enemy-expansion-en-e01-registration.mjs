...
check(ledgerReport.counts.registeredFamilies === 13 && ledgerReport.counts.publicFamilies === 13, 'current ledger must report thirteen registered EN-E01/EN-E02/EN-E04 families');
