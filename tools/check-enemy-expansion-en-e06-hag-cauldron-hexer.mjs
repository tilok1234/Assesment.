...
check(ENEMY_EXPANSION_LEDGER.find(({ id }) => id === 'EN-E06')?.gate === 'dryad-grove-tender-full-published-2026-08-09', 'ledger must preserve published Cauldron Hexer while identifying published Grove Tender');
