...
check(ENEMY_EXPANSION_LEDGER.find(({ id }) => id === 'EN-E06')?.gate === 'dryad-spore-cantor-full-candidate-2026-08-09', 'ledger must preserve published Cauldron Hexer while identifying candidate Spore Cantor');
