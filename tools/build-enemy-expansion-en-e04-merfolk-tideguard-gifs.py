...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e04-merfolk-tideguard"
...
raw_hash = build_gif(
    "raw",
    "en-e04-merfolk-tideguard-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e04-merfolk-tideguard-full-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Merfolk Tideguard full-suite GIFs.")
