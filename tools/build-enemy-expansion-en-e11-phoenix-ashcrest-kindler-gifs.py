...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e11-phoenix-ashcrest-kindler"
...
raw_hash = build_gif(
    "raw",
    "en-e11-phoenix-ashcrest-kindler-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e11-phoenix-ashcrest-kindler-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E11 Phoenix Ashcrest Kindler full-suite GIFs.")
