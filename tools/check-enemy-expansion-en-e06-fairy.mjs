...
check(ENEMY_EXPANSION_LEDGER.find((entry) => entry.id === 'EN-E06')?.gate === 'hag-blackthorn-matron-full-published-2026-08-09', 'the EN-E06 ledger must preserve Bramblewing while identifying published Blackthorn Matron');
