...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e07-kelpie-drownbridle-stalker"
...
raw_hash = build_gif(
    "raw",
    "en-e07-kelpie-drownbridle-stalker-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e07-kelpie-drownbridle-stalker-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E07 Kelpie Drownbridle Stalker full-suite GIFs.")
