...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e03-banner-khan-idle"
FRAMES = OUTPUT / "animation-frames-r3"
...
raw_hash = build_gif(
    ["raw-1.png", "raw-2.png"],
    "en-e03-banner-khan-idle-r3-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    ["complete-b-form-1.png", "complete-b-form-2.png"],
    "en-e03-banner-khan-idle-r3-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Banner Khan Idle review GIFs.")
