...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e12-basilisk-crownscale-crawler"
...
raw_hash = build_gif(
    "raw",
    "en-e12-basilisk-crownscale-crawler-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e12-basilisk-crownscale-crawler-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E12 Basilisk Crownscale Crawler full-suite GIFs.")
