...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e08-animated-armor-runeforge-custodian"
...
raw_hash = build_gif(
    "raw",
    "en-e08-animated-armor-runeforge-custodian-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e08-animated-armor-runeforge-custodian-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E08 Animated Armor Runeforge Custodian full-suite GIFs.")
