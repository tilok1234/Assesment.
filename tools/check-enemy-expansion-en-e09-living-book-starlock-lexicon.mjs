...
check(EN_E09_STARLOCK_LEXICON_GATE.status==='approved'&&EN_E09_STARLOCK_LEXICON_GATE.baseCheckpoint==='e7729e651044139bda7e4dcf14c3c2690dbd29be'&&EN_E09_STARLOCK_LEXICON_GATE.authorizedOn==='2026-08-12'&&EN_E09_STARLOCK_LEXICON_GATE.authorizationEvidence.includes('designer replied: lets keep going')&&EN_E09_STARLOCK_LEXICON_GATE.approvedOn==='2026-08-12'&&EN_E09_STARLOCK_LEXICON_GATE.approvalEvidence.includes('designer replied: APPROVED')&&EN_E09_STARLOCK_LEXICON_GATE.approvalEvidence.includes('3cd86b946115179fc566160e5045eccfda4fd5ce61ce44eae269634b07f3e92c')&&EN_E09_STARLOCK_LEXICON_GATE.approvedImplementation==='f11c2a0915588c616e1db7d8e461208f97a42706'&&EN_E09_STARLOCK_LEXICON_GATE.publicationState==='approved-not-published','private specialist gate drifted');
...
check(EN_E09_STARLOCK_LEXICON_GATE.scope.includes('80-frame Starlock Lexicon specialist Living Book')&&EN_E09_STARLOCK_LEXICON_GATE.animationContract.includes('body-owned spine-led sweep')&&EN_E09_STARLOCK_LEXICON_GATE.animationContract.includes('Cast aliases Attack exactly')&&EN_E09_STARLOCK_LEXICON_GATE.nextGate.includes('visually approved at implementation f11c2a0915588c616e1db7d8e461208f97a42706')&&EN_E09_STARLOCK_LEXICON_GATE.exclusions.includes('loose pages')&&EN_E09_STARLOCK_LEXICON_GATE.exclusions.includes('elite Living Book'),'motion or stop gate drifted');
