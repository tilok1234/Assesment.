...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e07-will-o-wisp-lantern-mote"
...
raw_hash = build_gif(
    "raw",
    "en-e07-will-o-wisp-lantern-mote-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e07-will-o-wisp-lantern-mote-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E07 Will-o-Wisp Lantern Mote full-suite GIFs.")
