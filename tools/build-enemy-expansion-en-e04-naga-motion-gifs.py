...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e04-naga-motion"
...
raw_hash = build_gif(
    "raw",
    "en-e04-naga-coilguard-motion-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e04-naga-coilguard-motion-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Naga Coilguard grouped motion GIFs.")
