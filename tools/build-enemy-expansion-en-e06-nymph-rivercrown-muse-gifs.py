...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e06-nymph-rivercrown-muse"
...
raw_hash = build_gif("raw", "en-e06-nymph-rivercrown-muse-full-suite-four-directions-labeled.gif")
assembled_hash = build_gif("complete-b-form", "en-e06-nymph-rivercrown-muse-full-suite-four-directions-labeled-complete-b-form.gif")
print("Generated the two exact labeled EN-E06 Nymph Rivercrown Muse full-suite GIFs.")
