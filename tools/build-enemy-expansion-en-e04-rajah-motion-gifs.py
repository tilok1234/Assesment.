...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e04-rajah-motion"
...
raw_hash = build_gif(
    "raw",
    "en-e04-temple-rajah-motion-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e04-temple-rajah-motion-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Temple Rajah grouped motion GIFs.")
