...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e11-raven-cinderquill-scavenger"
...
raw_hash = build_gif(
    "raw",
    "en-e11-raven-cinderquill-scavenger-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e11-raven-cinderquill-scavenger-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E11 Raven Cinderquill Scavenger full-suite GIFs.")
