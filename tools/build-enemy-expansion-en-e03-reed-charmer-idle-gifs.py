...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e03-reed-charmer-idle"
...
raw_hash = build_gif(
    ["raw-1.png", "raw-2.png"],
    "en-e03-reed-charmer-idle-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    ["complete-b-form-1.png", "complete-b-form-2.png"],
    "en-e03-reed-charmer-idle-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Reed Charmer Idle review GIFs.")
