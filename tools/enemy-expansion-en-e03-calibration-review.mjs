...
const output = path.join(root, 'enemy-expansion-review', 'en-e03-calibration');
...
const rows = Object.freeze([
  {
    ...
    registry: EN_E03_GIANT_CALIBRATION_REGISTRY,
    family: 'giant',
...
const rawBoard = renderBoard({
  title: 'EN-E03 GIANT CALIBRATION',
...
const report = {
  format: 'enemy-expansion-en-e03-giant-calibration-v1',
  sliceId: 'EN-E03',
  state: 'approved',
  artifact: 'en-e03-hill-breaker-calibration-raw.png',
  png: { width: rawBoard.width, height: rawBoard.height, sha256: rawHash },
  assembledArtifact: 'en-e03-hill-breaker-calibration-complete-b-form.png',
  ...
  approval: EN_E03_GIANT_CALIBRATION_GATE,
  candidateFrames,
  referenceFrames,
  guarantees: {
    candidateFamilies: EN_E03_GIANT_CALIBRATION_REGISTRY.families.length,
    candidateVariants: 1,
    candidateFrames: candidateFrames.length,
    publicCandidateFamilies: EN_E03_GIANT_CALIBRATION_REGISTRY.publicFamilies.length,
...
await writeFile(path.join(output, 'en-e03-hill-breaker-calibration.json'), JSON.stringify(report, null, 2) + '\n');

console.log('Generated the bounded EN-E03 Hill Breaker calibration evidence.');
