...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e04-venom-oracle-idle"
...
raw_hash = build_gif(
    ["raw-1.png", "raw-2.png"],
    "en-e04-venom-oracle-idle-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    ["complete-b-form-1.png", "complete-b-form-2.png"],
    "en-e04-venom-oracle-idle-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Venom Oracle Idle review GIFs.")
