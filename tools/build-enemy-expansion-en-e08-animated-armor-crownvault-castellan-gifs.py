...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e08-animated-armor-crownvault-castellan"
...
raw_hash = build_gif(
    "raw",
    "en-e08-animated-armor-crownvault-castellan-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e08-animated-armor-crownvault-castellan-full-suite-four-directions-labeled-complete-b-form.gif",
)
