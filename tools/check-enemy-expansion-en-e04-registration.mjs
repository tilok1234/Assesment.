...
check(engine.ENEMY_EXPANSION_REGISTRY.families.length === 43, 'the approved backlog integration must extend the stable registry to forty-three approved families');
...
check(ledgerReport.counts.registeredFamilies === 43 && ledgerReport.counts.publicFamilies === 43, 'the stable registry must report forty-three registered/public family records');
...
console.log('- Consumer catalog after approved backlog integration: 100 families / 316 variants');
