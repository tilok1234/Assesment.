...
check(engine.PUBLIC_ENEMIES.length === 67, 'EN-E03 Idle work must not alter the 67-family consumer catalog');
...
check(ledgerReport.counts.approved === 3 && ledgerReport.counts.implemented === 0 && ledgerReport.counts.planned === 19, 'current ledger must retain three approved, zero implemented, and nineteen planned slices');
