...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e03-reed-charmer-motion"
...
raw_hash = build_gif(
    "raw",
    "en-e03-reed-charmer-motion-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e03-reed-charmer-motion-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Reed Charmer grouped motion GIFs.")
