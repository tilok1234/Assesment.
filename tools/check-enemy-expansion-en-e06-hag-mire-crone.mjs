...
check(ENEMY_EXPANSION_LEDGER.find((entry) => entry.id === 'EN-E06')?.gate === 'dryad-spore-cantor-full-candidate-2026-08-09', 'EN-E06 ledger must preserve Mire Crone while identifying candidate Spore Cantor');
