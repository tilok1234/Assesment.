...
check(ENEMY_EXPANSION_LEDGER.find((entry) => entry.id === 'EN-E06')?.gate === 'hag-blackthorn-matron-full-candidate-2026-08-09', 'EN-E06 ledger must preserve Mire Crone while identifying candidate Blackthorn Matron');
