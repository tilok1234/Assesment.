...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e06-fairy-idle"
...
raw_hash = build_gif(
    ["raw-1.png", "raw-2.png"],
    "en-e06-fairy-bramblewing-scout-idle-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    ["complete-b-form-1.png", "complete-b-form-2.png"],
    "en-e06-fairy-bramblewing-scout-idle-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Fairy Bramblewing Scout Idle review GIFs.")
