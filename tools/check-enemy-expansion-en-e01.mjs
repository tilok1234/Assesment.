...
check(ledgerReport.counts.approved === 7 && ledgerReport.counts.implemented === 0, 'current ledger must report seven approved slices through EN-E03 and EN-E06 adoption');
