...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e04-birdfolk-aerie-scout"
...
raw_hash = build_gif(
    "raw",
    "en-e04-birdfolk-aerie-scout-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e04-birdfolk-aerie-scout-full-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Birdfolk Aerie Scout full-suite GIFs.")
