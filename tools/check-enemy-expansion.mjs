...
check(ledgerReport.counts.approved === 3, 'EN-F00, EN-E01, and EN-E02 must be the approved expansion slices');
...
console.log('Enemy expansion foundation validation passed after EN-E02 registration.');
