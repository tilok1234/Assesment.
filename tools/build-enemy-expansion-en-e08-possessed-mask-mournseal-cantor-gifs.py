...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e08-possessed-mask-mournseal-cantor"
...
raw_hash = build_gif(
    "raw",
    "en-e08-possessed-mask-mournseal-cantor-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e08-possessed-mask-mournseal-cantor-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E08 Possessed Mask Mournseal Cantor full-suite GIFs.")
