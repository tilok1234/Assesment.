...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e03-wildwood-hornlord-motion"
...
raw_hash = build_gif(
    "raw",
    "en-e03-wildwood-hornlord-motion-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e03-wildwood-hornlord-motion-suite-four-directions-labeled-complete-b-form.gif",
)

print("Generated the two exact labeled Wildwood Hornlord grouped motion GIFs.")
