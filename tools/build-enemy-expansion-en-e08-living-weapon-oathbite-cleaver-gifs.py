...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e08-living-weapon-oathbite-cleaver"
...
raw_hash = build_gif(
    "raw",
    "en-e08-living-weapon-oathbite-cleaver-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e08-living-weapon-oathbite-cleaver-full-suite-four-directions-labeled-complete-b-form.gif",
)
print("Generated the two exact labeled EN-E08 Living Weapon Oathbite Cleaver full-suite GIFs.")
