...
OUTPUT = ROOT / "enemy-expansion-review" / "en-e11-peacock-crownveil-sovereign"
...
def validate_inspection_atlas() -> None:
    source = OUTPUT / "en-e11-peacock-crownveil-sovereign-inspection-atlas.png"
...
raw_hash = build_gif(
    "raw",
    "en-e11-peacock-crownveil-sovereign-full-suite-four-directions-labeled.gif",
)
assembled_hash = build_gif(
    "complete-b-form",
    "en-e11-peacock-crownveil-sovereign-full-suite-four-directions-labeled-complete-b-form.gif",
)
validate_inspection_atlas()
print("Generated the two exact labeled EN-E11 Peacock Crownveil Sovereign full-suite GIFs.")
