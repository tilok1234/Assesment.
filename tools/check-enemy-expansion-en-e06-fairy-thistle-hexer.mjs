...
check(ENEMY_EXPANSION_LEDGER.find((entry) => entry.id === 'EN-E06')?.gate === 'hag-mire-crone-full-published-2026-08-09', 'the EN-E06 ledger must preserve published Thistle Hexer while identifying the published Mire Crone gate');
