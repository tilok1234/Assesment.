...
check(ENEMY_EXPANSION_LEDGER.find((entry) => entry.id === 'EN-E06')?.gate === 'dryad-grove-tender-full-candidate-2026-08-09', 'the EN-E06 ledger must preserve Thistle while identifying candidate Grove Tender');
