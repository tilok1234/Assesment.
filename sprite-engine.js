// ============================================================
// sprite-engine.js — procedural 8-bit sprite renderer
// 24×24 grid · 4 directions (side mirrored) · 4 animations
// idle(2) walk(4) attack(4) hurt(2) → 12-frame rows
// ============================================================
...
export const SHEET_COLS = ANIMS.reduce((a, x) => a + x.frames, 0); // 12

// ---------------- palette ----------------
const INK = '#1a1c2c';
const METAL = ['#b9c2cf', '#7e8a9c', '#e6ecf4'];
const GOLD  = ['#e8b93e', '#b7871f', '#f7dc85'];
const WOOD  = ['#8a5a33', '#63401f'];
const BONE  = ['#e9e4d0', '#b3ab90'];
const CREAM = ['#e8ddc4', '#c2b492'];
const BOOTS = ['#4a3524', '#2f2116'];
const PANTS = ['#5a4632', '#3d2f20'];
const IRONPANTS = ['#4a4f5c', '#343846'];
const STRINGC = '#dde2e8';
