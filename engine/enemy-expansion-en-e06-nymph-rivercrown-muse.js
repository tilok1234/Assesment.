...
export const EN_E06_RIVERCROWN_MUSE_CONTRACT = deepFreeze({
  ...
  state:'implemented-complete-motion-candidate', chassis:'slender-river-diadem-asymmetric-hair-draped-gown-nymph-v3',
...
export const EN_E06_RIVERCROWN_MUSE_GATE = deepFreeze({
  id:'en-e06-nymph-rivercrown-muse-full-v1', status:'candidate', baseCheckpoint:'983b76ad14dcaf7c3151196763e481237fcbedb1',
  ...
  approvedOn:null, approvalEvidence:'Pending explicit visual approval of the exact labeled all-four-direction raw/no-outline and Complete B + Form full-suite boards, the public Elf Mage plus approved Spring Dancer and Mist Weaver comparison, paired GIF evidence, and the three exact PNG review boards opened together in Aseprite.', publishedImplementation:null,
  ...
  nextGate:'Stop at the exact frozen Rivercrown Muse candidate review. Do not commit, publish, register Nymph, generate fixtures, add effects, release, start EN-E07, or broaden Wave 2 until the designer explicitly approves the presented boards and paired GIFs.',
});
