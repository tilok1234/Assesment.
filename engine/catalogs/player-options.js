...
export const WEAPONS = [
  ...
  { id: 'sword',      name: 'Sword',      category: 'blade' },
  { id: 'greatsword', name: 'Greatsword', category: 'blade' },
  { id: 'scimitar',   name: 'Scimitar',   category: 'blade' },
  { id: 'rapier',     name: 'Rapier',     category: 'blade' },
  { id: 'dagger',     name: 'Dagger',     category: 'blade' },
  { id: 'axe',        name: 'Axe',        category: 'blade' },
  { id: 'mace',       name: 'Mace',       category: 'blunt' },
  { id: 'warhammer',  name: 'Warhammer',  category: 'blunt' },
  { id: 'spear',      name: 'Spear',      category: 'polearm' },
  { id: 'club',       name: 'Club',       category: 'blunt' },
  { id: 'bow',        name: 'Bow',        category: 'ranged' },
  { id: 'crossbow',   name: 'Crossbow',   category: 'ranged' },
  { id: 'staff',      name: 'Staff',      category: 'magic' },
  { id: 'wand',       name: 'Wand',       category: 'magic' },
  { id: 'spellbook',  name: 'Spellbook',  category: 'magic' },
];
