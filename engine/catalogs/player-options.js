...
export const WEAPONS = [
  ...
  { id: 'sword',      name: 'Sword',      category: 'blade',   tier2Name: 'Runeblade' },
  { id: 'greatsword', name: 'Greatsword', category: 'blade',   tier2Name: 'Titan Greatsword' },
  { id: 'scimitar',   name: 'Scimitar',   category: 'blade',   tier2Name: 'Sunfang' },
  { id: 'rapier',     name: 'Rapier',     category: 'blade',   tier2Name: 'Royal Thorn' },
  { id: 'dagger',     name: 'Dagger',     category: 'blade',   tier2Name: 'Shadowfang' },
  { id: 'axe',        name: 'Axe',        category: 'blade',   tier2Name: 'Twinhead Axe' },
  { id: 'mace',       name: 'Mace',       category: 'blunt',   tier2Name: 'Morning Star' },
  { id: 'warhammer',  name: 'Warhammer',  category: 'blunt',   tier2Name: 'Runic Maul' },
  { id: 'spear',      name: 'Spear',      category: 'polearm', tier2Name: 'Dragon Spear' },
  { id: 'club',       name: 'Club',       category: 'blunt',   tier2Name: 'Ironwood Crusher' },
  { id: 'bow',        name: 'Bow',        category: 'ranged',  tier2Name: 'Kingsguard Warbow' },
  { id: 'crossbow',   name: 'Crossbow',   category: 'ranged',  tier2Name: 'Siege Arbalest' },
  { id: 'staff',      name: 'Staff',      category: 'magic',   tier2Name: 'Archmage Staff' },
  { id: 'wand',       name: 'Wand',       category: 'magic',   tier2Name: 'Crystal Wand' },
  { id: 'spellbook',  name: 'Spellbook',  category: 'magic',   tier2Name: 'Ancient Grimoire' },
];
