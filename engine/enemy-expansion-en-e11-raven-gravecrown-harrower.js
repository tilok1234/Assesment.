...
export const EN_E11_RAVEN_GRAVECROWN_HARROWER_GATE = deepFreeze({
  ...
  initialPublishedHandoff: 'e1645f03572073d00c9c9a9f96b70e9daf2d484a',
  ...
  nextGate: 'The exact Gravecrown Harrower implementation 4d05b1f4f0ff5113bb31c4ac7011a393b6d877be, approval record 8ec032c2ff90aceffeb8f8cf9533fccac89d68df, and initial published handoff e1645f03572073d00c9c9a9f96b70e9daf2d484a are pushed and remote verified; this reconciliation completes the bounded Raven elite publication tuple. No continuation request accompanied the pixel approval, so no Owl, Phoenix, other Bird family, or other sprite lane is open. Public or outline registration, fixtures, effects, child assets, release, accepted drift, and a pull request remain closed. The distinct outlined PNG remains review evidence only and does not authorize outline registration.',
});
...
export const EN_E11_RAVEN_GRAVECROWN_HARROWER_FAMILY = deepFreeze({
  ...
  review: {
    ...
    scale: 6,
    notes: 'Published and reconciled private Gravecrown Harrower elite Raven only, bound to exact implementation 4d05b1f4f0ff5113bb31c4ac7011a393b6d877be, approval record 8ec032c2ff90aceffeb8f8cf9533fccac89d68df, initial published handoff e1645f03572073d00c9c9a9f96b70e9daf2d484a, candidate digest 06892d2e8583a2c7ba2dc06aca12a94007230801b645db478cac187e538465d9, and its six frozen review hashes. No continuation request was supplied, so the next gate stays closed. Keep public or outline registration, fixtures, effects, child assets, Owl, Phoenix, release, accepted drift, and a pull request separate.',
  },
});
