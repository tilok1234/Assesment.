...
export const EN_E12_BASILISK_IRONHALO_TYRANT_GATE = deepFreeze({
  ...
  initialPublishedHandoff: 'f0d4b503162703b88213372e1e2831162d1a9ccf',
...
export const EN_E12_BASILISK_IRONHALO_TYRANT_FAMILY = deepFreeze({
  ...
  review: {
    ...
    notes: 'Published and reconciled private Ironhalo Tyrant elite Basilisk only, bound to exact revised implementation 7a00ef8691da6df2821cf3ad02437198d0d9f2e6, approval record 16f797813361c61f0bcda2933ecb86d03b0d66cc, initial published handoff f0d4b503162703b88213372e1e2831162d1a9ccf, candidate digest ea00f445e8f807098b6392cd3cf81fedbf0a29d6eb96434495ab5af9b3308a6f, and its six frozen review hashes. The designer replied aproved to the revised packet after the rigid-square animation repair, with no continuation request; no next enemy role or family is open. Keep public or outline registration, fixtures, approved-enemy package mutation, effects, child assets, Manticore, Sphinx, boss work, release, accepted drift, and a pull request separate.',
  },
});
