...
export const EN_E06_CONTRACT_CARDS = deepFreeze([
  ...
  contractCard({
    ...
    variants: [
      ...
      { id: 'blackthorn-matron', name: 'Blackthorn Matron', role: 'elite', status: 'implemented-full-candidate', brief: 'Briar-armored elder Hag with a crown of hooked blackthorn and a heavier raking silhouette.' },
    ],
  }),
  contractCard({
    id: 'dryad',
    ...
    variants: [
      { id: 'grove-tender', name: 'Grove Tender', role: 'common', status: 'planned', brief: 'Young bark-limbed Dryad with a leaf mantle and narrow humanoid trunk line.' },
