...
export const EN_E06_CONTRACT_CARDS = deepFreeze([
  ...
  contractCard({
    ...
    variants: [
      ...
      { id: 'spore-cantor', name: 'Spore Cantor', role: 'specialist', status: 'implemented-full-approved', brief: 'Fungal-crowned Dryad whose spore clouds remain separate effects.' },
      { id: 'heartwood-warden', name: 'Heartwood Warden', role: 'elite', status: 'implemented-full-approved', brief: 'Dense heartwood guardian with branch pauldrons while retaining fey rather than Treant scale.' },
    ],
  }),
  contractCard({
    id: 'redcap',
    ...
    variants: [
      ...
      { id: 'bloodcap-reaver', name: 'Bloodcap Reaver', role: 'elite', status: 'implemented-full-approved', brief: 'Broad-shouldered Redcap raider with a torn crimson cap and heavier cleaving read.' },
    ],
  }),
  contractCard({
    id: 'nymph',
    ...
    variants: [
      ...
      { id: 'mist-weaver', name: 'Mist Weaver', role: 'specialist', status: 'implemented-full-approved', brief: 'Veiled Nymph caster whose mist layers remain external effects.' },
      { id: 'rivercrown-muse', name: 'Rivercrown Muse', role: 'elite', status: 'implemented-full-approved', brief: 'Regal river Nymph with a vertical diadem, long flowing hair, diagonal sash, and self-contained character silhouette.' },
    ],
  }),
]);
