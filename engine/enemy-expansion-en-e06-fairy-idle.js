...
export const EN_E06_CONTRACT_CARDS = deepFreeze([
  ...
  contractCard({
    ...
    variants: [
      ...
      { id: 'rivercrown-muse', name: 'Rivercrown Muse', role: 'elite', status: 'implemented-full-candidate', brief: 'Regal river Nymph with a broad flowing crown and self-contained character silhouette.' },
    ],
  }),
]);
