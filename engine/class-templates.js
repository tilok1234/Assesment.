...
export const CLASS_TEMPLATES = Object.freeze([
  ...
  Object.freeze({
    id: 'barbarian',
    name: 'Barbarian',
    description: 'Fur-clad frontline raider with greatswords, axes, spears, and crushing clubs but no shield progression.',
    outfit: 'barbarian',
    defaultWeapon: 'axe',
    defaultShield: 'none',
  ...
  Object.freeze({
    id: 'necromancer',
    name: 'Necromancer',
    description: 'Deathshrouded caster with ritual blades, staffs, wands, spellbooks, and bone or arcane shields.',
    outfit: 'necromancer',
  ...
  Object.freeze({
    id: 'paladin',
    name: 'Paladin',
    description: 'Plate-armored holy champion with great blades, maces, warhammers, and the heaviest martial shields.',
    outfit: 'plate',
    defaultWeapon: 'sword',
  ...
  Object.freeze({
    id: 'druid',
    name: 'Druid',
    description: 'Wilderness spellfighter in a ranger coat with daggers, spears, staffs, wands, and primal shields.',
    outfit: 'ranger',
    defaultWeapon: 'staff',
    defaultShield: 'none',
