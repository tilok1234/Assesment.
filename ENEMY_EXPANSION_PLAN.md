...
- Current approved private EN-E12 elite Basilisk / initial publication handoff
  ...
  all 232 fixtures stay exact. The designer replied `aproved` to this exact
  revised packet. Pixel approval binds only to implementation
...
- Published preceding approved private EN-E12 specialist Basilisk / elite gate
  ...
  next` publishes only Crownscale Crawler and opens exactly one private
  specialist Basilisk full 80-frame candidate under the selected
  `baked-single-actor-grounded-four-clawed-crowned-serpent` topology. Because
  the specialist was not pre-named, this lane names only Mirrorcrest Mesmer: a
  connected lean, low, long Basilisk with deep teal and blue-black hide, violet
  belly scales, an arched S-neck, connected opaline moon-silver plates and split
  crescent mirror crest, cyan eyes, dark plum jaw, ivory fangs, four separately
  grounded rose-copper claws, and one connected hooked loop-tail. Attack braces
  all four claws, raises the split crest into a connected body-owned aperture,
  holds a gaze-lock posture, folds, and recovers. Cast aliases Attack exactly;
  Death aliases Hurt H1,H2,H2,H2. Detached gaze, venom, glow, dust, projectiles,
  impacts, and child assets remain absent. The exact frozen candidate digest is
  `3ff5c75cd5272e66cfad42b84c5dbb1e86c20b67f506845923734cda24569a80`.
  Raw / outlined / Form / Crownscale-Gloamgaze-Marsh Crocodile comparison PNG
  hashes are
  ...
  in pixels and alpha from approved Crownscale, approved Gloamgaze, and public
  Marsh Crocodile. All 40 side views preserve the lean long-body read; all
  eight split-aperture rises and eight body-owned gaze locks pass. Minimum alpha
  distances / maximum IoUs are 69/0.765, 97/0.657, and 109/0.553. Opaque range
  is 226-289; Complete B adds 10,114 pixels and Form changes 10,991. Original-
  resolution inspection covers all four PNGs and eight raw/Form phase boards;
  the 480x96 20x4 atlas has 80 non-empty hard-alpha cells and zero boundary
  contact, all six principal files parse in Aseprite, and regeneration exactly
  reproduces the frozen hashes. Public remains 100/316 and all 232 fixtures are
...
- Published preceding approved private EN-E12 common Basilisk / specialist gate
  open
...
- Current approved private elite Phoenix published / next enemy gate closed
  ...
  this reconciliation completes the bounded elite publication tuple. The same
...
- Approved preceding private common Phoenix published / specialist gate open
  ...
  this reconciliation completes the common publication tuple. The
  ...
  the exact packet. The specialist authoring/review gate is open, but its
  commit and push remain closed until exact pixel approval. Registration,
  fixtures, effects, child assets, resurrection
...
- Current approved private Owl elite published / next gate closed
  ...
  press, and refolds. Cast aliases Attack and Death aliases Hurt H1,H2,H2,H2;
  all halos, rings, seals, wisps, loose feathers, dust, glow, projectiles, air
  blades, shock rings, and impacts remain external. Its frozen digest is
  ...
  this reconciliation completes the bounded Owl elite publication tuple.
  ...
  Hushmask, approved Moonveil, and public Harpy. All 16 eclipse-gate views,
  expected identity marks, exact aliases/mirrors, and eight exact flashes
  pass. Public remains 100/316 and all 232 fixtures stay exact. Approval-local
  focused/fast gates pass again in about 0.7s/74.6s. Final published-state
  focused/fast/full gates pass in about 0.7s/74.1s/139.1s. The four exact PNGs,
  all eight phase sheets, transparent inspection atlas, and both exact GIFs
  were inspected at original resolution. Aseprite parsed all six
  principal files, and regeneration reproduced every frozen hash. No
  continuation request accompanied the approval, so the next gate stays
  closed. Public or outline registration, fixtures, effects, child assets,
  Phoenix, another family, release, accepted drift, a PR, and every broader
  gate remain closed.
...
- Current approved private common Owl published / next gate closed
  ...
  published-state focused/fast/full gates pass in about 0.9s/68.0s/133.9s.
  No continuation request was supplied, so public or outline registration,
...
- Current approved private elite Raven published / next gate closed
  ...
  next` advances the documented Raven role order from approved specialist to
  exactly one private elite full 80-frame candidate under the selected
  ...
  beak and talons, crimson seal marks, and one connected barbed black wedge
  tail. Attack braces on both talons, raises a full body-owned gravegate,
  drives a hooked-beak and plated-shoulder harrow press, and refolds. Loose
  feathers, seal flares, shadow wisps, dust, glow, projectiles, air blades, and
  impacts remain external. Its frozen digest is
  ...
  Focused/fast/full gates pass in about 0.9s/69.7s/108.8s: 80/80 connected,
  bounded, grounded, two-talon, broad-elite, approved-source-footprint frames;
  16/16 gravegate views; 54/54 expected eye views; 72/72 gravecrown,
  crimson-seal, and mantle-wing views; 8/8 exact flashes; exact aliases and
  mirrors; and 80/80 pixel-plus-alpha distinctions from approved Cinderquill,
  approved Mournglass, and public Harpy. Opaque range is 205-334, Complete B
  adds 8,620 outline pixels, and Form changes 8,723 pixels. Public remains
  ...
  published-state focused/fast/full gates pass in about 0.8s/64.6s/123.0s.
  No continuation request was supplied, so registration, fixtures, effects,
  child assets, Owl, Phoenix, release, accepted drift, a PR, and every broader
  gate remain closed.
...
- Current approved private specialist Raven published / next gate closed
  ...
  lets keep going` advances the documented Raven role order from common to
  exactly one private specialist full 80-frame candidate under the selected
  `baked-single-actor-grounded-folded-wing-corvid` topology. Because the role
  was not pre-named, this lane names only Mournglass Scrier. It preserves the
  approved compact grounded corvid beneath violet-black plumage, indigo-slate
  wings, a pale throat, connected silver moon-glass brow crest and quill bars,
  cool-teal eyes and omen marks, a hooked steel beak, two dark-steel talons,
  and one connected notched wedge tail. Attack opens a tall body-owned scrying
  vane, drives a precise hooked-beak wing rake, and refolds. Omen rings,
  scrying panes, shadow wisps, loose feathers, dust, glow, projectiles, air
  blades, and impacts remain external. Its frozen digest is
  ...
  Focused/fast/full gates pass in about 0.5s/61.7s/109.0s: 80/80 connected,
  bounded, grounded, two-talon, compact-corvid, approved-source-footprint
  frames; 16/16 scrying-vane views; 54/54 expected eye-and-beak views; 72/72
  moon-glass and omen-mark views; 8/8 exact flashes; exact aliases and mirrors;
...
- Current approved private common Raven published / next gate closed
  ...
  pushed, remote-verified Crowncoil final reconciliation
  `090399f2e05f83d102f4d672670f64ffdcd24fed`, the designer replied `approved`
  to the proposed `baked-single-actor-grounded-folded-wing-corvid` topology
  and the stated plan to build exactly one private common Raven full 80-frame
  candidate. Cinderquill Scavenger is one connected compact low-forward
  blue-black and slate natural corvid with a short smoky throat, hooked horn
  beak, muted rust-cinder quills, two separated bronze-gray talons,
  copper-gold eyes, and one connected black wedge tail. Attack opens a broad
  tapered wing screen, drives a hooked-beak wing rake, and refolds without
  baked effects. Its frozen digest is
  ...
  Focused/fast/full validation passes in about 0.7s/58.0s/112.6s: all 80
  frames are structural, two-talon, compact-corvid, and distinct from approved
  Crowncoil, approved Rainfan, and public Harpy at opaque range 175-284;
  16/16 wing-screen views; exact aliases and mirrors; public 92/294; all 232
  fixtures exact; zero child assets/effects/registration. The four exact PNGs,
  four raw phase sheets, and transparent inspection atlas were inspected at
  ...
  published-state focused/fast/full gates pass in about 1.0s/67.4s/105.6s.
  No continuation request was supplied, so Raven specialist or elite,
  Owl, Phoenix, registration,
...
- Current approved private elite Cockatrice published / Raven topology gate open
  ...
  a crown-hook coil. Attack plants both talons in a crown-brace, raises both
  mantle wings, drives the connected crown-hook tail with a short beak strike,
  and settles into a sovereign recovery without baked effects. Its frozen
  digest is
  ...
  Focused/fast/full validation passes in about 0.8s/61.8s/112.2s: all 80
  frames are connected, bounded, grounded, two-talon, and pixel-plus-alpha
  distinct from Gloamgaze Stalker, Bramblecomb Scratcher, and Marsh Crocodile
  ...
  tuple. Approval-local focused/fast gates pass again in about 0.8s/56.0s.
  Final published-state focused/fast/full gates pass in about
  1.0s/75.3s/119.4s. The approved continuation opens only the documented Raven
  topology decision gate. It does not choose a topology or approve Raven
  pixels. Owl, Phoenix,
...
- Current approved private specialist Cockatrice published / next gate closed
  ...
  next` approves only that common packet and opens exactly one private
  ...
  Stalker is one connected lean, high-necked teal/slate and dusk-plum
  cockerel-and-serpent actor with a forked violet comb, pale mint throat mask,
  angular rose-copper wings, two separated copper talon contacts, and one long
  connected blue-black tail ending in a high wedge hook. Attack plants both
  talons, raises a forked gaze-screen posture, crosses a wing through the face
  line, lifts the tail into a hooked counter-feint, drives a short beak feint,
  ...
  Focused/fast/full validation passes in about 0.8s/58.2s/116.3s: all 80
  frames connected, bounded, grounded, two-talon, and pixel-plus-alpha
  distinct from Bramblecomb, Aerie Scout, and Marsh Crocodile at opaque range
  ...
  this reconciliation completes the bounded publication tuple. Approval-local
  ...
  closed. Final published-state focused/fast/full gates pass in about
  0.8s/56.5s/107.6s. Registration, fixtures, effects, child
...
- Current approved private common Cockatrice published / specialist gate open
  ...
  next` opened only the Cockatrice topology decision. The designer replied
  `approved` to
  `baked-single-actor-grounded-serpent-tailed-cockerel`, authorizing exactly
  one private common Cockatrice 80-frame candidate without approving its
  pixels. Bramblecomb Scratcher is one connected low-slung cockerel-and-serpent
  actor with a jagged crimson comb and wattle, hooked old-ivory beak,
  moss-scaled neck, warm umber body, folded straw-and-rust wings, two separated
  broad ochre talon contacts, and one connected forest-green scale-marked tail.
  Attack plants both talons, snaps the hooked beak forward, lashes the
  body-owned tail through two phases, and recovers without a baked effect. Its
  frozen digest is
  `0d55f7dc0fafac3014bcdfa1ea2dce3cbb4b5ba09eb6c52f6c723067702b9764`.
  Raw / distinct Complete B outlined / Complete B + Form / comparison PNG
  hashes are `c42f11a84cdd6f711eb485f1a3125e9438603acba9a7c4ec17aac5aae0df5f00`,
  ...
  Focused validation passes all 80 structural, two-talon, hybrid-span, alias,
  mirror, palette, and three-way pixel/alpha-distinction cases at opaque range
  200-253, including 16/16 connected tail-lash views. The transparent
  inspection atlas is exact. Focused/fast/full gates pass in about
  0.5s/57.5s/116.4s. Public remains 92/294 and all 232 fixtures remain
...
- Approved preceding private elite Mammoth checkpoint published / Rhino distinction decision opened later
  ...
  distinction cases at opaque range 274-315. Pre-approval fast/full gates pass
  at 61.4s/112.5s; approval-local fast/full gates pass at 62.9s/115.7s; final
  published-state fast/full gates pass at 61.7s/122.9s with public 92/294 and all 232 fixtures unchanged.
  ...
  `702a93964de696cb246ca144b0d9a946c81875c9`, approval record
  ...
  Public/outline registration, fixtures, effects, child assets, Rhino, Rhino
  Boss work, release, accepted drift, a PR, and every broader gate remain closed.
...
- Approved preceding private specialist Mammoth checkpoint published / elite Mammoth gate open
  ...
  connected lean, high-shouldered slate-blue Mammoth with a pale glacier face
  and connected trunk, long swept old-ivory tusks, lichen belly, frost-vein
  chevrons, muted-wine ears, cyan eyes, short tail, four weight-bearing legs,
  four separated broad feet, and a body-owned lateral trunk feint into an
  effect-free hooked tusk sweep. Its exact digest is
...
- Approved preceding private common Mammoth checkpoint published / specialist Mammoth gate open
  ...
  `f0ced3c777c478a4077fb439ccd8b4b363ea52ac`, approval record
  ...
  this reconciliation completes the bounded publication tuple. Final
  published-state full validation passes in 106.7s. The continuation suffix
  opens exactly one private specialist Mammoth full 80-frame candidate on a
...
- Approved preceding private elite Stag checkpoint published / Mammoth topology decision open
  ...
  `baked-single-actor-antlered-grounded-quadruped` topology. Gloamcrown
  Sovereign on `codex/en-e10-stag-elite` is a broad midnight-plum royal cervid
  with an old-ivory mantle, near-black violet face and lower legs, a vast
  connected weathered-gold crown rack with verdigris bands, wine markings,
  mulberry ears, a pale blaze, amber-gold eyes, four split hooves, and a
  body-owned antler lift into a planted crown press. Its exact 80-frame digest
  is `5a80240ca6bfb16eb6a53b0b95b5214323a9dde25814b48fb39e9caaf11e4855`.
  Raw / distinct Complete B outlined / Complete B + Form / comparison PNG
...
- Current approved private art checkpoint published / no next Stag gate
  ...
  `baked-single-actor-antlered-grounded-quadruped` topology. Briarstep Harrier
  ...
  validation passes in 126.9s with 80/80 connected, bounded, grounded,
  split-hoof, cervid-span, and Mossrack / Miremane / Dire Wolf
  ...
  gate is open. Public/outline registration,
...
- Approved preceding private art checkpoint published / specialist gate open
  ...
  The exact four PNGs are open together in Aseprite as sprites 99, 103, 107,
  and active 111. The outlined PNG is review evidence only, not outline
  registration. The designer replied `approved lets do next` to the exact
  posted packet. Accepted implementation
...
- Approved preceding published private art checkpoint (2026-08-13): from clean published Stonecurl
  ...
  Cliffcoil Strider on `codex/en-e10-ram-specialist` is a connected grounded
  lean blue-slate Ram with charcoal-blue face and lower legs, long connected
  pale-limestone swept coil horns, cool pale belly and beard, sea-glass
  sure-foot chevrons, muted-wine ears, cyan eyes, near-black hooves, and a
  body-owned sidestep horn charge. Its exact 80-frame digest is
  ...
  required distinct Complete B outlined, Complete B + Form, and comparison PNGs
  plus two GIFs are hash-frozen and deterministic. Pre-approval focused / fast /
  full gates pass in 0.7s / 59.0s / 113.9s and approval-local focused / fast
  gates pass in 0.6s / 57.9s with public 92/294 and all 232 fixtures unchanged.
  Final published-state full validation passes in 111.0s with the same boundary.
...
- Approved preceding published private art checkpoint (2026-08-13): from clean published Scarcrest
  ...
  this reconciliation completes the bounded publication tuple. At that
  checkpoint registration, fixtures, effects, child assets, later roles and
  families, release, accepted drift, and a PR remained closed. The designer
  later separately said `lets do nex t`, opening only the private specialist
  Cliffcoil Strider candidate above.
...
- Approval: the exact packet was presented and the designer replied `approved
  ...
  same reply opens only one private elite Living Weapon
  art candidate from this clean published reconciliation. Registration, fixtures,
...
attachments, and detached horns remain external Effects Off. At that published
checkpoint registration, fixtures, effects, specialist or elite Ram, Stag,
Mammoth, Rhino, Rhino Boss work, and all later gates remained closed. The
designer later separately said `lets do nex t`, opening only the private
specialist below.

Cliffcoil Strider is the authorized specialist Ram from clean published
Stonecurl reconciliation `67ba19086669b9135286784b6c9c39f682ca3032`. It uses a
lean blue-slate body, charcoal-blue face and lower legs, long connected
pale-limestone swept coil horns, cool pale belly and beard, sea-glass sure-foot
chevrons, muted-wine ears, cyan eyes, near-black hooves, and a body-owned
sidestep horn charge. Its exact 80-frame digest is
`1ca2ce85dc6bd4b291e6ede4754f58c2a5bd4278b50acfb699926f9626dd9b29`.
All 80 frames pass connected, one-cell bounded, grounded, four-hoof,
quadruped-span, alias, mirror, and pixel/alpha distinction checks against
approved Stonecurl Grazer and Miremane Courser plus public Dire Wolf at opaque
range 233-259. The hash-frozen packet includes raw, required distinct Complete B
outlined, Complete B + Form, and comparison PNGs plus two GIFs and regenerates
deterministically. Pre-approval focused / fast / full gates pass in 0.7s / 59.0s
/ 113.9s and approval-local focused / fast gates pass in 0.6s / 57.9s with
public 92/294 and all 232 fixtures unchanged. Final published-state full
validation passes in 111.0s with the same boundary. The four exact PNGs are
open together in Aseprite as sprites 67, 71, 75, and active 79. The outlined
...
outlined, Complete B + Form, and comparison PNGs plus two GIFs and regenerates
deterministically. Pre-approval focused / fast / full gates pass in 0.9s /
...
record `2387ec0a584f77b3473827ef0568823bf86b4fd2`, and initial published handoff
`699e17fe7749b365feabbd15f323eac15aaf4337` are pushed and remote verified;
this reconciliation completes the bounded publication tuple. Final
published-state full validation passes in 106.7s. The continuation suffix opens
exactly one private specialist Mammoth full 80-frame candidate on a new
isolated branch from this clean checkpoint under the selected topology.
Registration, fixtures, effects, child assets, elite
Mammoth, Rhino, Rhino Boss work, release, accepted drift, a PR, and every
broader gate remain closed.

Frostvein Wayfinder is the authorized private specialist Mammoth from clean,
published, remote-verified Tundrahide reconciliation
`125b1b81d0f6fa977c3bf674964a45131e65f3ab`. On branch
`codex/en-e10-mammoth-specialist`, it uses a leaner high-shouldered slate-blue
wool chassis, deep indigo lower body and feet, pale glacier face and connected
trunk, long swept old-ivory tusks with sea-glass undertones, a lichen-pale
belly, blue-green frost-vein chevrons, muted-wine ears, cyan eyes, a short
tail, four weight-bearing legs, four separated broad feet, and a body-owned
lateral trunk feint into an effect-free hooked tusk sweep. Its exact 80-frame
digest is
`2fbcd71017d4acacb9e8cfee31d984ad9f039634af79cb656180b11a08f1250e`.

All 80 frames pass connected, one-cell bounded, grounded, four-broad-foot,
long-tusk high-shouldered-span, alias, mirror, and pixel/alpha distinction
checks against approved Tundrahide Grazer and Cliffcoil Strider plus public
...
pass, with pre-approval fast/full at 61.4s/112.5s and approval-local fast/full
at 62.9s/115.7s; final published-state fast/full gates pass at 61.7s/122.9s with public 92/294, all 232
fixtures unchanged, zero child assets/effects, and no public or outline registration. The exact raw,
outlined, Complete B + Form, and comparison PNGs are open together in Aseprite
...
`78c574c1b50e4b17e2a3a551500cbaf6d17c855e` are pushed and remote verified;
this reconciliation completes the bounded publication tuple. No continuation
clause was supplied, so no next Mammoth role or Rhino gate is open; Rhino Boss
work and all broader gates remain closed.

### EN-E11 - Birds

- Status: `phoenix-elite-approved-published-next-enemy-gate-closed`
...
Final published-state focused and full gates pass again. No next Phoenix role
or other family is open; a fresh explicit continuation is required. Do not
register, regenerate fixtures, add outline enrollment,
...
Final published-state focused and full gates pass again in about 1.0s and
118.8s.
...
Internal visual QA accepted the packet. The specialist authoring/review gate
is now open, but its commit and push remain closed until exact pixel approval.
Do not register, regenerate fixtures,
...
`0e2dbbc6f519c1e135a57686ab1e0600d0327239`, and initial published handoff
`afa265a17feca93d2bd1c49cc844c3259e751d04` are pushed and remote verified;
this reconciliation completes the bounded Owl common publication tuple. The
reply contains no continuation request, so Owl specialist or elite, Phoenix,
...
Final published-state focused, fast, and full gates pass in about 0.9s, 68.0s,
and 133.9s.

The implementation, approval record, and initial published handoff are remote
verified; this reconciliation completes Hushmask's bounded Owl common
publication tuple. No continuation request was supplied, so the next gate
stays closed. Public or outline registration, fixtures, effects, child assets,
Owl specialist or elite, Phoenix, release, accepted drift, and a PR remain
closed. A fresh explicit continuation request is required before any later
lane can open.

#### Current approved Raven common published / next gate closed

After the complete Crowncoil publication tuple was pushed, remote verified,
and reconciled at `090399f2e05f83d102f4d672670f64ffdcd24fed`, the open Raven
decision gate proposed `baked-single-actor-grounded-folded-wing-corvid` and
stated that approval would build exactly one private common Raven full
80-frame candidate. The designer replied `approved`. That selected the
topology and authorized this candidate without approving its pixels. After the
...
body, slate folded wings, muted rust-cinder nape and shoulder quills, two
separated bronze-gray talon contacts, copper-gold eyes, and one connected black
wedge tail. Attack crouches on both talons, opens a broad tapered wing screen,
drives a hooked-beak wing rake with the wedge tail counterbalancing, and
refolds. Cast aliases Attack exactly; Death aliases Hurt H1,H2,H2,H2. Loose
feathers, shadow wisps, dust, glow, projectiles, and impacts remain external.
...
and `687767db7f6d9e3ba642c57c69cfd170541ba6ac3125d0b5d5a9d5fc16100919`.
Focused validation passes 80/80 connected, bounded, grounded, separated
two-talon, and compact-corvid-span frames; 16/16 broad wing-screen views;
54/54 expected eye-and-beak views; 72/72 head, throat, wedge-tail,
rust-cinder, and wing views; 8/8 exact flashes; exact aliases and mirrors; and
80/80 pixel-plus-alpha distinctions from approved Crowncoil Basilarch,
approved Rainfan Forager, and public Harpy Screecher. Opaque range is 175-284.
Focused/fast/full gates pass in about 0.7s/58.0s/112.6s; public remains 92/294,
all 232 fixtures stay exact, and child assets, effects, public registration,
and outline registration remain zero. The four exact PNGs, four raw phase
...
The implementation, approval record, and initial published handoff are remote
verified; this reconciliation completes the bounded Raven common publication
tuple. The outlined PNG is review evidence only. No continuation request was
supplied, so Raven specialist or elite, Owl, Phoenix, registration, fixtures,
effects, child assets, release, accepted drift, and a PR remain closed. A fresh
explicit continuation request is required before any later lane can open.
...
- Status: `elite-approved-private-publication-in-progress`
...
record `16f797813361c61f0bcda2933ecb86d03b0d66cc` are pushed and remote
verified; only the initial published handoff and final reconciliation remain.
The reply contains no continuation request, so the next enemy gate remains
closed. Do not register, add outlines, fixtures, effects, or child assets,
mutate the approved-enemy copy package, start Manticore, Sphinx, or a Boss
pilot, release, accept drift, or open a PR.
